(function () {
  ...
  const toggleDoorAndButtonText = () => {
    $('.slide-top').hasClass('slide-open') ?
      $('.show-items-btn').val('Show Items') && $('.slide-top').toggleClass("slide-open")
      :
      $('.show-items-btn').val('Hide Items') && $('.slide-top').toggleClass("slide-open");
  };
